...
public class GroupVsPaneDemo extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.show();
        System.out.println(rect1.localToScene(rect1.getBoundsInLocal()));
        System.out.println(rect2.localToScene(rect2.getBoundsInLocal()));
        System.out.println(rect3.localToScene(rect3.getBoundsInLocal()));
        System.out.println(rect4.localToScene(rect4.getBoundsInLocal()));
    }
